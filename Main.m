...
% Joint positions
rho(1,:)=out.R.signal2.data(4,1:3,1);
rho(2,:)=out.R.signal3.data(4,1:3,1);
rho(3,:)=out.R.signal4.data(4,1:3,1);
rho(4,:)=out.R.signal5.data(4,1:3,1);
rho(5,:)=out.R.signal6.data(4,1:3,1);
rho(6,:)=out.R.signal7.data(4,1:3,1);
rho(7,:)=out.R.signal8.data(4,1:3,1);
rho=rho';
...
R(1:3,1:3,1)=out.R.signal2.data(1:3,1:3,1);
R(1:3,1:3,2)=out.R.signal3.data(1:3,1:3,1);
R(1:3,1:3,3)=out.R.signal4.data(1:3,1:3,1);
R(1:3,1:3,4)=out.R.signal5.data(1:3,1:3,1);
R(1:3,1:3,5)=out.R.signal6.data(1:3,1:3,1);
R(1:3,1:3,6)=out.R.signal7.data(1:3,1:3,1);
R(1:3,1:3,7)=out.R.signal8.data(1:3,1:3,1);
